...
public class Swagger {
    ...
    public static final String  API_TITLE="Supermarket  API";
    public static final String  API_DESCRIPTION="this app take too long time to develop which should not be";
